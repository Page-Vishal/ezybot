...
from assets.query2response import mongo_query
from assets.promptNmessgaes import get_messages
from assets.getTools import getTools
...
def response_from_bot(query:str) -> str:
    """
